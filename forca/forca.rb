...
# É necessario ter o numero de linhas na primeira linha
...
def pede_um_chute_valido(chutes, errors, mascara)
  cabecalho_de_tentativa chutes, errors, mascara
  loop do
    chute = pede_um_chute
...
def joga(nome)
  ...
  while errors < 5
    ...
    chute = pede_um_chute_valido chutes, errors, mascara
    chutes << chute
